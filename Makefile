...
PROJECT_REPO ?= github.com/milkpirate/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/cloudflare/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-cloudflare_v4.31.0
...
XPKG_REG_ORGS ?= ghcr.io/milkpirate
