...
type ProxyEndpointInitParameters struct {
	...
	// (Set of String) The networks CIDRs that will be allowed to initiate proxy connections.
	// The networks CIDRs that will be allowed to initiate proxy connections.
	Ips []*string `json:"ips,omitempty" tf:"ips,omitempty"`

	// (String) Name of the teams proxy endpoint.
...
type ProxyEndpointObservation struct {
	...
	// (String) The FQDN that proxy clients should be pointed at.
...
// ProxyEndpoint is the Schema for the ProxyEndpoints API. Provides a Cloudflare Teams Proxy Endpoint resource. Teams Proxy Endpoints are used for pointing proxy clients at Cloudflare Secure Gateway.
