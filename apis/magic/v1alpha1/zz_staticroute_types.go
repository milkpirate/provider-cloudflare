...
type StaticRouteInitParameters struct {
	...
	// (List of String) List of Cloudflare colocation regions for this static route.
	// List of Cloudflare colocation regions for this static route.
	ColoNames []*string `json:"coloNames,omitempty" tf:"colo_names,omitempty"`

	// (List of String) List of Cloudflare colocation names for this static route.
	...
	// (String) The nexthop IP address where traffic will be routed to.
	// The nexthop IP address where traffic will be routed to.
	Nexthop *string `json:"nexthop,omitempty" tf:"nexthop,omitempty"`

	// (String) Your network prefix using CIDR notation.
	// Your network prefix using CIDR notation.
	Prefix *string `json:"prefix,omitempty" tf:"prefix,omitempty"`

	// (Number) The priority for the static route.
	// The priority for the static route.
	Priority *float64 `json:"priority,omitempty" tf:"priority,omitempty"`

	// (Number) The optional weight for ECMP routes. Modifying this attribute will force creation of a new resource.
...
// StaticRoute is the Schema for the StaticRoutes API. Provides a resource, that manages Cloudflare static routes for Magic Transit or Magic WAN. Static routes are used to route traffic through GRE tunnels.
