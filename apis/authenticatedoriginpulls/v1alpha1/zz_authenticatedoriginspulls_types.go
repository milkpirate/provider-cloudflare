...
type AuthenticatedOriginsPullsInitParameters struct {
	...
	// (Boolean) Whether to enable Authenticated Origin Pulls on the given zone or hostname.
	// Whether to enable Authenticated Origin Pulls on the given zone or hostname.
	Enabled *bool `json:"enabled,omitempty" tf:"enabled,omitempty"`

	// Hostname Authenticated Origin Pulls on, using the provided certificate.
...
type AuthenticatedOriginsPullsObservation struct {
	...
	// Zone Authenticated Origin Pulls.
...
// AuthenticatedOriginsPulls is the Schema for the AuthenticatedOriginsPullss API. Provides a Cloudflare Authenticated Origin Pulls resource. A cloudflare_authenticated_origin_pulls resource is required to use Per-Zone or Per-Hostname Authenticated Origin Pulls.
