...
// GetInitParameters of this AuthenticatedOriginsPulls
func (tr *AuthenticatedOriginsPulls) GetInitParameters() (map[string]any, error) {
...
// LateInitialize this AuthenticatedOriginsPulls using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AuthenticatedOriginsPulls) LateInitialize(attrs []byte) (bool, error) {
	params := &AuthenticatedOriginsPullsParameters{}
