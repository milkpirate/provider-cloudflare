...
type AddressObservation struct {
	...
	// (String) The date and time the destination address has been modified.
...
// Address is the Schema for the Addresss API. The Email Routing Address https://developers.cloudflare.com/email-routing/setup/email-routing-addresses/#destination-addresses resource allows you to manage Cloudflare Email Routing Destination Addresses.
