...
import (
	...
	"github.com/milkpirate/provider-cloudflare/apis"
	"github.com/milkpirate/provider-cloudflare/apis/v1alpha1"
	"github.com/milkpirate/provider-cloudflare/config"
	"github.com/milkpirate/provider-cloudflare/internal/clients"
	"github.com/milkpirate/provider-cloudflare/internal/controller"
	"github.com/milkpirate/provider-cloudflare/internal/features"
)

func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Cloudflare").DefaultEnvars()
